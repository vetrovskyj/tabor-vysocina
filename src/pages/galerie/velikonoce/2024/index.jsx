...
const Galerka = ({ data }) => {
      ...
      fetch(node.publicURL)
        ...
        .then(blob => {
          ...
          if (index === currentImages.length - 1) {
            zip.generateAsync({ type: "blob" }).then(content => {
              saveAs(content, "fotky-vysocina-velikonoce2024.zip");
              setDownloading(false); // Reset the downloading state
            });
          }
        });
  ...
  const handleDownload = () => {
    ...
    link.href = '../../../../components/velikonoce-2024/Velikonoce_2024.png'; // Adjust the path based on your project structure
    link.download = 'Velikonoce_2024.png';
    link.click();
  };
...
export const pageQuery = graphql`
  query {
    gallery: allFile(
      filter: { relativeDirectory: { eq: "velikonoce-2024" } }
